...
<%-- 
 ...
 --%>
		...
		<table align="center">
			...
			<tr>
				<td>Product Name</td>
				<td><input type="text" name="pName" value="${pro.name}"/></td>
			</tr>
			<tr>
			<td>Select Category</td>
			...
			<tr>
				<td>Price</td>
				<td><input  type="number" name="pPrice"  value="${pro.price}"/></td>
			</tr>
			<tr>
				<td>Description</td>
				<td><input  type="text" name="pDescription"  value="${pro.description}"/></td>
			</tr>
			<tr>
				<td>Quantity</td>
				<td><input  type="text" name="pQuantity" value="${pro.quantity}"/></td>
			</tr>
